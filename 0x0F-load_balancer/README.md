...
For this project, I've written Bash scripts to automate the work. All scripts are designed to configure a brand new Ubuntu server to match the task requirements.</p>
